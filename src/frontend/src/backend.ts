...
export class Backend implements backendInterface {
    ...
    async addTransaction(arg0: bigint, arg1: string, arg2: string, arg3: string): Promise<bigint> {
    ...
    async getTodaysSummary(): Promise<{
        ...
        if (this.processError) {
            try {
                const result = await this.actor.getTodaysSummary();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async seedDemoTransactions(): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.seedDemoTransactions();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
